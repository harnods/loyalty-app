export const IMAGES = {
  ...
  heroCoins:      '/icons/hero-coins.png',
  iconEarn:       '/icons/icon-earn.png',
  iconRedeem:     '/icons/icon-redeem.png',
  iconHistory:    '/icons/icon-history.png',
  arrow:          '/icons/arrow-right.svg',
  mekariQontak:   '/icons/logo-mekari-qontak.svg',
  chevronLeft:    '/icons/chevron-left.svg',
  caretDown:      '/icons/chevron-left.svg',
  warning:        '/icons/warning.svg',
  searchIcon:     '/icons/search.png',
  rewardDripBag:  '/images/reward-drip-coffee.png',
  rewardOnigiri:  '/images/reward-onigiri.png',
  rewardDiscount: '/images/reward-discount.png',
  rewardToteBag:  '/images/reward-tote-bag.png',
  rewardBento:    '/images/reward-bento.png',
  rewardPourOver: '/images/reward-pour-over.png',
...
const MACHIMOTO_VOUCHERS = [
  {
    ...
    thumb: '/images/reward-drip-coffee.png',
  ...
  },
  {
    ...
    thumb: '/images/reward-tote-bag.png',
    thumbStyle: null,
  ...
  },
  {
    ...
    thumb: '/images/reward-onigiri.png',
  ...
  },
  {
    ...
    thumb: '/images/reward-discount.png',
    thumbStyle: null,
...
const TOMODACHI_VOUCHERS = [
  {
    ...
    thumb: '/images/reward-pour-over.png',
    thumbStyle: null,
